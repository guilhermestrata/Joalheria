...
function NavScrollExample() {
  ...
  return (
    ...
    <Navbar bg="light" expand="lg">
        ...
        <Nav.Link className="link-menu" href="/home">Home</Nav.Link>
        <Nav.Link className="link-menu" href="/home">Sobre</Nav.Link>
        <Nav.Link className="link-menu" href="/home">Contato</Nav.Link>
        </Nav>
    </Tab.Container>
        </Offcanvas.Body>
      </Offcanvas>
